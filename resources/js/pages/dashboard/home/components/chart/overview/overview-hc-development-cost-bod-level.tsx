...
type OverviewCostBodLevel = {
    bod_level: number;
    total_cost: string;
};

export default function OverviewHCDevelopmentCostBodLevel() {
    const [isLoading, setIsLoading] = useState(false);
    const [data, setData] = useState<OverviewCostBodLevel[]>();
    ...
    useEffect(() => {
        const fetchOverviewData = async () => {
            ...
            try {
                const response = await axios.get<OverviewCostBodLevel[]>(
                    '/api/training/realization/bod-level',
                );
