...
type OverviewCostOrganizer = {
    name: string;
    total_cost: string;
};

export default function OverviewHCDevelopmentCostOrganizer() {
    const [isLoading, setIsLoading] = useState(false);
    const [data, setData] = useState<OverviewCostOrganizer[]>();
    ...
    useEffect(() => {
        const fetchOverviewData = async () => {
            ...
            try {
                const response = await axios.get<OverviewCostOrganizer[]>(
                    '/api/training/realization/organizer',
                );
