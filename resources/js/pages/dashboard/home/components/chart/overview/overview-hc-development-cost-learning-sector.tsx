...
type OverviewCostLearningSector = {
    learning_sector: string;
    total_cost: string;
};

export default function OverviewHCDevelopmentCostLearningSector() {
    const [isLoading, setIsLoading] = useState(false);
    const [data, setData] = useState<OverviewCostLearningSector[]>();
    ...
    useEffect(() => {
        const fetchOverviewData = async () => {
            ...
            try {
                const response = await axios.get<OverviewCostLearningSector[]>(
                    '/api/training/realization/learning-sector',
                );
