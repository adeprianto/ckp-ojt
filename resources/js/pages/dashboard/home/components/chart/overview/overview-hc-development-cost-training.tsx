...
type OverviewCostTraining = {
    name: string;
    total_cost: string;
};

export default function OverviewHCDevelopmentCostTraining() {
    const [isLoading, setIsLoading] = useState(false);
    const [data, setData] = useState<OverviewCostTraining[]>();
    ...
    useEffect(() => {
        const fetchOverviewData = async () => {
            ...
            try {
                const response = await axios.get<OverviewCostTraining[]>(
                    '/api/training/realization/training',
                );
